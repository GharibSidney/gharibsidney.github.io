      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-2">
          ...
          <div className="flex-shrink-0 ">
            <Avatar className="w-70 h-70 mb-5">
              <AvatarImage src={"/photo_sidney.jpg"} alt="Photo" />
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <span className="mb-6 text-muted-foreground items text-lg">
              I'm a master student in the <LinkPreview url="https://mistlab.ca/" className="font-bold">
              MIST Lab</LinkPreview> at <LinkPreview url="https://www.polymtl.ca/" className="font-bold">
              Polytechnique Montréal</LinkPreview>. I also hold a bachelor degree in Software Engineering.
